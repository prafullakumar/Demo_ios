...
public enum CirculerProgressViewGlowMode {
    case forward, reverse, constant, noGlow
}

@IBDesignable
public class CirculerProgressView: UIView, CAAnimationDelegate {
    ...
    private var progressLayer: CirculerProgressViewViewLayer {
        get {
            return layer as! CirculerProgressViewViewLayer
        }
    }
    ...
    @IBInspectable public var glowMode: CirculerProgressViewGlowMode = .forward {
        didSet {
    ...
    override public class var layerClass: AnyClass {
        return CirculerProgressViewViewLayer.self
    }
    ...
    private class CirculerProgressViewViewLayer: CALayer {
        ...
        var glowMode: CirculerProgressViewGlowMode = .forward
        ...
        private enum GlowConstants {
            ...
            static func glowAmount(forAngle angle: Double, glowAmount: CGFloat, glowMode: CirculerProgressViewGlowMode, size: CGFloat) -> CGFloat {
                switch glowMode {
                case .forward:
        ...
        override init(layer: Any) {
            ...
            let progressLayer = layer as! CirculerProgressViewViewLayer
